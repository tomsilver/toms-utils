...
def test_openai_llm():
    ...
    logprobs = llm.get_multiple_choice_logprobs("Fill in the blank with the appropriate homophone: The ____ of the king lasted for ten years.", choices=["rein", "reign", "rain"], seed=0)
